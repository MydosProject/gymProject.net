    ...
    : Controller
{
        ...
        int? conversationId)
    {
        ...
        var readResult = await messagingService.MarkConversationAsReadAsync(
            userId,
            conversationRow.Id);
        ...
        string? body)
    {
        ...
        var recipientUserId =
            await messagingService
                .GetOtherParticipantUserIdAsync(
                    userId,
                    conversationId);
       ...
       if (!string.IsNullOrWhiteSpace(recipientUserId))
        {
            ...
            await notificationService
                .CreateAndPublishAsync(
                    ...
                    "Yeni mesaj",
                    "Eğitmenin sana yeni bir mesaj gönderdi.",
                    $"/Member/Messages?conversationId={conversationId}",
                    conversationId);
        }
